...
const {newTrade, getUserTrades, currentUser, getContestRank, getMyContestRank, getContestPnl, getLastFiveTrade, getContestHistoryPnl,getRedisLeaderBoard} = require('../../controllers/contestTradeController');
