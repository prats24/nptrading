                ...
                <MDBox pt={1} pb={2}> 
                    <Grid container spacing={2}>
                        <Grid item xs={12} md={12} lg={12} >
                            ...
                            <MDBox >
                                <Typography sx={{ margin: 2, marginRight:10, backgroundColor:"#f0f2f5", borderRadius:2, p: 0.5, fontSize: 19}}>Company Day Wise P&L Report (Mock)</Typography>
                            </MDBox>
                            <MDBox >
                                <Typography sx={{ margin: 2, p: 0.5, backgroundColor:"#f0f2f5", borderRadius:2, fontSize: 19 }}>Start Date</Typography>
                                </MDBox>
                            <TextField
                            ...
                            <MDBox >
                                <Typography color="dark" sx={{ margin: 2, p: 0.5, backgroundColor:"#f0f2f5", borderRadius:2, fontSize: 19 }}>End Date</Typography>
                                </MDBox>
                            <TextField
                                id="outlined" variant="standard" type="date"
